document.addEventListener("DOMContentLoaded", () => {
  ...
  // Header stays visible on desktop - no hide on scroll
  // Just add subtle styling changes on scroll if needed
  const header = document.getElementById("header");

  window.addEventListener("scroll", () => {
    const currentScrollY = window.scrollY;
    
    // Desktop: Header stays visible, add subtle shadow on scroll
